...
public class HouseController {
    ...
    @GetMapping(value="/searchAvailable")
...
/*
    ...
    public ResponseEntity<Iterable<House>> getCitybyAvailble(@RequestParam(name="available") int available, @RequestParam(name="housecity") String housecity){
        return new ResponseEntity<Iterable<House>>(houseRepository.findByCityandAvailable(available,housecity), HttpStatus.ACCEPTED);
    }*/
   ...
   @GetMapping("/host")
    ...
    @GetMapping("/hostId")
     public ResponseEntity<House> getHouseById(int idHouse) {
